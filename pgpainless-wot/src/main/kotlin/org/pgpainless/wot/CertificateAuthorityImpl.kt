...
class CertificateAuthorityImpl(
    ...
    companion object {
        ...
        /**
         * Instantiate a [CertificateAuthority] using the Web of Trust. It is advised to keep the
         * result of this operation around for later reuse, since this method does some heavy
         * lifting.
         *
        ...
        fun webOfTrustFromCertificateStore(
            ...
            val network =
                PGPNetworkParser(certificateStore).buildNetwork(referenceTime = referenceTime)
            return CertificateAuthorityImpl(
                network, trustRoots, certificateStore, shortestPathAlgorithmFactory)
        }
    }
