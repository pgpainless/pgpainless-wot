...
class CertRevokedHardVectors: ArtifactVectors {
    ...
    val bobFpr = Identifier("90E02BFB03FAA04714D1D3D87543157EF3B12BE9")
    val bobUid = "<bob@example.org>"
    // Certified by: 219AAB661C8AAF4526DBC31AA751A7A0532863BA
    // Certified by: 219AAB661C8AAF4526DBC31AA751A7A0532863BA

    val carolFpr = Identifier("BF680710128E6BCCB2268154569F5F6BFB95C544")
    val carolUid = "<carol@example.org>"
    // Certified by: 219AAB661C8AAF4526DBC31AA751A7A0532863BA

    val daveFpr = Identifier("46945292F8F643F0573AF71183F9C1A4759A16D6")
