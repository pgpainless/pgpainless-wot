...
class Regex1Vectors: ArtifactVectors {
    ...
    val bobFpr = Identifier("20C812117FB2A3940EAE9160FEE6B4E47A096FD1")
    val bobUid = "<bob@example.org>"
    // Certified by: 3AD1F297E4B150F75DBFC43476FB81BFE0665C3A

    val carolFpr = Identifier("BC30978345D789CADECDE492F54B42E1625E1A1D")
    val carolUid = "<carol@example.org>"
    // Certified by: 20C812117FB2A3940EAE9160FEE6B4E47A096FD1

    val daveFpr = Identifier("319810FAD46CBE96DAD7F1F5B014902592999B21")
    val daveUid = "<dave@other.org>"
    // Certified by: 20C812117FB2A3940EAE9160FEE6B4E47A096FD1

    val edFpr = Identifier("23D7418EA0C6A42A54C32DBE8D4FE4911ED08467")
    val edUid = "<ed@example.org>"
    // Certified by: 319810FAD46CBE96DAD7F1F5B014902592999B21

    val frankFpr = Identifier("7FAE20D68EE87F74368AF275A0C40E741FC1C50F")
