...
class MultipleUserIds3Vectors: ArtifactVectors {
    ...
    val bobFpr = Identifier("28C108707090FCDFF630D1E141FB02F0E397D55E")
    ...
    val carolFpr = Identifier("9FB1D2F41AB5C478378E728C8DD5A5A434EEAAB8")
    val carolUid = "<carol@example.org>"
    // Certified by: 28C108707090FCDFF630D1E141FB02F0E397D55E

    val daveFpr = Identifier("0C131F8959F45D08B6136FDAAD2E16A26F73D48E")
    val daveUid = "<dave@example.org>"
    // Certified by: 28C108707090FCDFF630D1E141FB02F0E397D55E

    val edFpr = Identifier("296935FAE420CCCF3AEDCEC9232BFF0AE9A7E5DB")
    val edUid = "<ed@example.org>"
    // Certified by: 0C131F8959F45D08B6136FDAAD2E16A26F73D48E

    val frankFpr = Identifier("A72AA1B7D9D8CB04D988F1520A404E37A7766608")
