...
class Regex3Vectors: ArtifactVectors {
    ...
    val bobFpr = Identifier("A75DC1A1EDA5282F3A7381B51824E46BBCC801F0")
    val bobUid = "<bob@example.org>"
    // Certified by: D8CFEBBA006E2ED57CF45CC413F0BAE09D94FE4E

    val carolFpr = Identifier("4BCD4325BDACA452F0301227A30CB4BCC329E769")
    val carolUid = "<carol@example.org>"
    // Certified by: A75DC1A1EDA5282F3A7381B51824E46BBCC801F0

    val daveFpr = Identifier("2E1AAA8D9A22C94ACCA362A22B34031CD5CB9380")
    val daveUid = "<dave@other.org>"
    // Certified by: A75DC1A1EDA5282F3A7381B51824E46BBCC801F0

    val edFpr = Identifier("F645D081F480BE26C7D2C84D941B3E2CE53FAF16")
    val edUid = "<ed@example.org>"
    // Certified by: 2E1AAA8D9A22C94ACCA362A22B34031CD5CB9380

    val frankFpr = Identifier("AFAB11F1A37FD20C85CF8093F4941D1A0EC5749F")
    val frankUid = "<frank@other.org>"
    // Certified by: 2E1AAA8D9A22C94ACCA362A22B34031CD5CB9380

    val georgeFpr = Identifier("D01C8752D9BA9F3F5F06B21F394E911938D6DB0A")
    val georgeUid = "<george@their.org>"
    // Certified by: 2E1AAA8D9A22C94ACCA362A22B34031CD5CB9380

    val henryFpr = Identifier("B99A8696FD820192CEEE285D3A253E49F1D97109")
