...
"""
        val args =
            "-k ${keyRingPath()} -r ${v.aliceFpr} -a 100 authenticate ${v.ellenFpr} ${v.ellenUid}"
                .split(" ")
...
"""
        val args =
            "--certification-network -k ${keyRingPath()} -r ${v.aliceFpr} -a 100 authenticate ${v.ellenFpr} ${v.ellenUid}"
                .split(" ")
